...
@section('name_title','Editar producto | Inelco IT Solutions')
            ...
            <div class="row">
                <div class="panel-body">
                    <div class="panel panel-default">
                        <div class="panel-heading"><h4>Editar producto con clave: <b style="font-weight: 600">{{ $producto->clave }}</b></h4></div>
                        <div class="panel-body">

                            {!! Form::model($producto, ['url' => ['admin/productos',$producto->id],'method'=>'PATCH']) !!}
                                ...
                                <div class="col-md-1">
                                    <img id="holder" src="{{ $producto->logo_prod }}" style="margin-top:15px;max-height:100px;" class="img-responsive">
                                </div>
                                ...
                                <div class="col-md-1">
                                    <img id="holder2" src="{{ $producto->img1_prod }}" style="margin-top:15px;max-height:100px;" class="img-responsive">
                                </div>
                                ...
                                <div class="col-md-1">
                                    <img id="holder3" src="{{ $producto->img2_prod }}" style="margin-top:15px;max-height:100px;" class="img-responsive">
                                </div>
                                ...
                                <div class="col-md-1">
                                    <img id="holder4" src="{{ $producto->img3_prod }}" style="margin-top:15px;max-height:100px;" class="img-responsive">
                                </div>
                                ...
                                <div class="col-md-1">
                                    <img id="holder5" src="{{ $producto->img4_prod }}" style="margin-top:15px;max-height:100px;" class="img-responsive">
                                </div>
                                ...
                                <div class="col-md-1">
                                    <img id="holder6" src="{{ $producto->img5_prod }}" style="margin-top:15px;max-height:100px;" class="img-responsive">
                                </div>
                                ...
                                <div class="col-md-2">
                                    <img id="holder7" src="{{ $producto->flyer_prod }}" style="margin-top:15px;max-height:100px;" class="img-responsive">
                                </div>
                                ...
                                <div class="col-md-offset-5 col-md-6">
                                    <div class="form-group">
                                        {!! Form::button('Actualizar producto',['type'=>'submit', 'class'=>'btn btn-primary']) !!}
                                    </div>
                                </div>
