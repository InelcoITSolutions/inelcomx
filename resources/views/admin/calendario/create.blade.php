...
@section('name_title','Crear nuevo evento | Inelco IT Solutions')
            ...
            @if(count($category) === 0)
                <div class="alert alert-warning">
                    <div class="container-fluid">
                        ...
                        <p><b>Alerta:</b> No hay ningúna categoría de eventos. Asegurese de registrar <a href="{{ url('admin/categorias_eventos') }}">aquí</a>.</p>
                    </div>
                </div>
            @endif
            ...
            <div class="row">
                <div class="panel-body">
                    <div class="panel panel-default">
                        <div class="panel-heading"><h4>Agregar un nuevo evento</h4></div>
                        <div class="panel-body">
                            {!! Form::open(array('url' =>'admin/calendario')) !!}
                                ...
                                {{--<div class="col-md-2">
                                    <div class="togglebutton">
                                        <label class="control-label">
                                            {!! Form::checkbox('habilitado','NO') !!}
                                            <span class="mensaje">Desabilitado</span>
                                        </label>
                                    </div>
                                </div>--}}
                                ...
                                <div class="col-md-2">
                                    <div class="togglebutton">
                                        <label>
                                            <input type="checkbox" id="habile" value="NO">
                                            <input style="display: none;visibility: hidden;" type="text" id="inhabil" name="habilitado" value="NO">
                                            <span class="mensaje">Deshabilitado</span>
                                        </label>
                                    </div>
                                </div>
  ...
  {{--                               <div class="col-md-2">
                                    <div class="togglebutton">
                                        <label>
                                            <input type="checkbox" id="habile" value="NO">
                                            <input style="display: none;visibility: hidden;" type="text" id="inhabil" name="habilitado" value="NO">
                                            <span class="mensaje">Inelco</span>
                                        </label>
  
                                        <label>
                                            {!! Form::checkbox('syca', 'syca', true); !!}
                                            
                                            <span class="mensaje">Syca</span>
                                        </label>
                                    </div>
                                </div> --}}
                                ...
                                <div class="col-md-offset-5 col-md-6">
                                    <div class="form-group">
                                        {!! Form::button('Agregar evento',['type'=>'submit', 'class'=>'btn btn-primary']) !!}
                                    </div>
                                </div>
                            {!! Form::close() !!}
                        </div>
