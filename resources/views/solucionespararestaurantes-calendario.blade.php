    ...
    <section class="eventos secciones">
        <div class="container">
           ...
           <h3 class="title-h3"> Selecciona el tipo de evento que deseas </h3>
            <br>
{{-- se cambia --}}
            <a  id='activo' class="btn btn-default btn-lg " href="{{ url('/solucionespararestaurantes-calendario')}}" >Todos</a>
        ...
        @if(count($calendariorestaurantes) > 0)
            @php
                $lastmes=0;
                $lastanio=0;
            @endphp
            ...
            @foreach ($calendariorestaurantes as $evento)
