...
@section('contenido')
    ...
    <section class="eventos secciones">
        <div class="container">
          <div id="filtros" class="text-center">
           <h3 class="title-h3"> Selecciona el tipo de evento que deseas </h3>
            ...
            <a class="btn btn-default btn-lg" href="{{ url('/calendario-webinar')}}" >Webinar</a>
            <a  class="btn btn-default btn-lg" href="{{ url('/calendario-cursos')}}" >Cursos</a>
            <a id='activo' class="btn btn-default btn-lg" href="{{ url('/calendario-presentaciones')}}" >Presentaciones</a>
        ...
        @if(count($calendarioPresentaciones) > 0  )
            @php
                $lastmes=0;
                $lastanio=0;
            @endphp
            ...
            @foreach ($calendarioPresentaciones as $evento)
