...
@section('contenido')
    ...
    <section class="eventos secciones">
        <div class="container">
          <div id="filtros" class="text-center">
           <h3 class="title-h3"> Selecciona el tipo de evento que deseas </h3>
            ...
            <a id='activo' class="btn btn-default btn-lg" href="{{ url('/calendario-conferencias')}}" >Conferencias</a>
        ...
        @if(count($calendarioConferencias) > 0  )
            @php
                $lastmes=0;
                $lastanio=0;
            @endphp
            ...
            @foreach ($calendarioConferencias as $evento)
