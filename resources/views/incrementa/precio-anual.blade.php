    ...
    <div class="col-md-4">
        ...
        <div class="col-md-4"  >
            ...
            <h4 class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  <b>Precios para planes de <button id="buscar" type="button" >pago anual<span class="caret"></span></button></b>
...
<div class="col-md-1" id="prim">
                ...
                <div class="col-md-2 col-sm-4 box-solutions pullUp" id="listpres-color1" >
                ...
                <div class="col-md-2 col-sm-4 box-solutions pullUp" id="listpres-color" > 
                   
                        
                        <h3><b>Básico</b></h3>
                        <p align="center"> 1 Usuario</p>
                        <p class="text-center"> <span class="symbol">$</span><span class="preci">291 </span><span class="code">MXN</span><span class="period">Mes</span></p>
                ...
                <div class="col-md-2 box-solutions pullUp" id="profes-color3" > 
                        
                       <h3><b>Profesional</b></h3>
                        <p align="center"><span class=" colorprof"> 5 Usuarios<span></p>
                        <p class="text-center"> <span class=" colorprof symbol">$</span><span class=" colorprof  preci">1,463 </span><span class=" colorprof  code">MXN</span><span class="colorprof period">Mes</span></p>
                        <p align="center"><span class=" colorprof">en pago anual</span></p>
                        <br>
                ...
                <div class="col-md-2 box-solutions pullUp" id="listpres-color" >
                            ...
                            <p class="text-center"> <span class="symbol">$</span><span class="preci">2,360 </span><span class="code">MXN</span><span class="period">Mes</span></p>
                            <p align="center">en pago anual</p>
                            <br>
                    ...
                    <div class="col-md-2 box-solutions pullUp" id="listpres-color" >
                            ...
                            <p class="text-center"> <span class="symbol">$</span><span class="preci">3,358 </span><span class="code">MXN</span><span class="period">Mes</span></p>
                            <p align="center">en pago anual</p>
                            <br>
