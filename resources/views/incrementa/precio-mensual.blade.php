    ...
    <div class="col-md-4">
        ...
        <div class="col-md-4" >
            ...
            <h4 class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  <b>Precios para planes de <button id="buscar" type="button" >pago mensual<span class="caret"></span></button></b>
...
<div class="col-md-1" id="prim">
                ...
                <div class="col-md-2 box-solutions pullUp" id="listpres-color" > 
                        ...
                        <p class="text-center"> <span class="symbol">$</span><span class="preci">560 </span><span class="code">MXN</span><span class="period">Mes</span></p>
                ...
                <div class="col-md-2 box-solutions pullUp" id="profes-color" > 
                        
                       <h3><b>Profesional</b></h3>
                        <p align="center"><span class=" colorprof"> 5 Usuarios<span></p>
                        <p class="text-center"> <span class=" colorprof symbol">$</span><span class=" colorprof  preci">1,950 </span><span class=" colorprof  code">MXN</span><span class="colorprof period">Mes</span></p>
