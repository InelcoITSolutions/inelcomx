...
@section('contenido')
    ...
    <section class="secciones sae-pages" id="mas">
        <div class="container">
            ...
            <div class="row">                
                <div class="col-md-6">  
                    <h5 class="title-h5"><strong>Control desde dispositivos móviles</strong></h5>
                    <ul>
                ...
                <div class="col-md-6 imagencontainer">
                    <img src="/images/products/saenube/inelco-aspel-app_sae_movil-nube.jpg" alt="sae movil" class="img-responsive">
                </div>
            </div>
        </div>
    </section>
