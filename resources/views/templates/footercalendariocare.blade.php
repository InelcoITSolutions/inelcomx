<section class="footer">
    <div class="container">
            ...
            <div class="col-xs-6 col-md-6 col-sm-6 footer-w3ls1">
                <div class="inner footer-w3ls2">
                    <div align="left" class="logo">
                        <img alt="" class="img-responsive" height="60" src="/images/calendarioCare/Inelco-logo-care-consulting.png" width="180"/>
                    </div>
                    <p class="descripcion">
                        En
                        <b>
        ...
        <ul class="social-icons1">
            <li>
                <a href="https://www.facebook.com/CareConsultoria/" target="_blank">
