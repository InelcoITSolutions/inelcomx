...
<head>
    ...
    <title>Calendario eventos | Care Consulting</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <link rel="stylesheet" href="/css/bootstrap.min.css">
    <link rel="stylesheet" href="/css/mis-estilos-care.css">
...
<body>
     ...
     <div class="container-fluid">
            <div class="row">
                <div class="col-md-3 col-xs-2">
                    <ul>
                        <li><a href="https://www.facebook.com/NuevoNOI/" target="_blank"><span class="icon-facebook"></span></a></li>
                ...
                <div class="col-md-9 col-xs-8">
                    <ul>
                        ...
                        <li><span class="icon-mail5"></span> contacto@aspelsoluciones.com</li>
                                ...
                                <li><a href="{{ url('https://www.careconsulting.com/') }} "><span class="glyphicon glyphicon-home"></span> Inicio</a></li>
    ...
    <div class="col-md-12 fondo-gray">
        <div class="col-md-9 ">
            <h2 id="tias" class="title-h2"><b>Calendario de eventos Care Consulting</b></h2>
        ...
        <div class="col-md-3 ">
        <img alt="inelco-aspel-coi-transp" class="img-responsive" width="100%"  src="/images/calendarioCare/Inelco-logo-care-consulting.png">
        </div>
    </div>
...
@push('add-js')   
    ...
    @include('templates.footercalendariocare')
