...
@section('name_title','Asesoría | Inelco IT Solutions')
...
@section('contenido')
	...
	@include('servicios.asesoria.banner-asesoria')

	<section class="descripcion-prod desc-asesoria secciones ">
	    <div class="container">
	        <div class="row">
	            <div class="col-md-8">
	...
	<section class="word-frase sections " id="frase-asesoria">
...
<div id="mas" style="padding-top: 12px">
	...
	<section class="caracteristicas-prod secciones" style="margin-top:-64px;">
		...
		<a href="{{url('contacto')}}" style="text-decoration: none">
			<button id="btn-asesoria-prob1" class="btn btn-inelco btn-lg center-block">Lo quiero</button>
		</a>
	</section>
</div>
