...
<head>
    ...
    <title>Curso {{ $landinfo->nombre_evento }} | Inelco IT Solutions</title>
...
<body class="{{ $landinfo->estilos }}">
          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="text-center">El evento: Curso <b>{{ $landinfo->nombre_evento }}</b> ha terminado.</h3>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="wow fadeInDown" data-wow-delay="0.3s">
                            <h1 class="text-center">Curso {{ $landinfo->nombre_evento }}</h1>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="wow fadeInDown text-center" data-wow-delay="0.9s">
                            <a class="ancla " href="#registrarme">
    ...
    <section class="paraquien secciones">
        <div class="container">
            <div class="row">
                <div class="wow fadeInLeft" data-wow-delay="0.5s">
                    <h2 class="text-center">¿Quien debe asistir?</h2>
                </div>
                <div class="col-md-12">
                    @for($i=1; $i<5; $i++)
                        <?php 
                        ...
                        @if($cont[$i]!=='')
                            <div class="wow fadeInDown" data-wow-delay="0.{{ $i }}s">
                                <div class="col-sm-1 col-xs-3"><p class="text-right"><span class="icon-checkmark2"></span></p></div>
    ...
    <section class="secciones temario">
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-sm-8">
                    <h3><b>Temario del curso</b></h3>
                    <ul id="lista-temas"></ul>
                </div>
                <div class="col-md-4 col-sm-4 text-center">
                    <p class="text-center"></p><a href="{{$landinfo->link_temario}}" target="_blank" class="btn btn-primary btn-sm">Ver temario completo</a>
                </div>
            </div>
        </div>
    </section>
