        ...
        <div class="fondo-gray">
         <div class="container">
           <div class="row">
            ...
            <div class="col-md-5 col-sm-5 secciones">
            ...
            <div class="col-md-12 col-sm-12" id="info">
            <div class="wow fadeInLeft" data-wow-delay="0.5s">

            <h3 class="text-left"> Webinar</h3>
            <h1 class="text-left p-color-blnc">{{ $landinfo->nombre_evento }}</h1>

             
               <ul class="p-color-blnc" id="lista-temas"></ul>
             
           
             <h2 class="text-center">{{ $meses[$m-1] }} {{ $landinfo->numero_dias_evento }}, {{ $landinfo->anio }} | {{ $landinfo->horario_evento }}</h2>
                    ...
                    <div class="col-md-12" >
                        ...
                        @if($landinfo->precio_evento <>0)
                            <p class="text-left p-color-blnc">¡Registrarme ahora!</p>
                        @else
                            <p class="text-left p-color-blnc">¡Registrarme ahora! <b>¡GRATIS!</b></p>
                        @endif
