...
<head>
    ...
    <title>Presentacion {{ $landinfo->nombre_evento }} | Inelco IT Solutions</title>
...
<body class="{{ $landinfo->estilos }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="wow fadeInDown" data-wow-delay="0.3s">
                            <h1 class="text-center">Presentación {{ $landinfo->nombre_evento }}</h1>
                        </div>
    ...
    <section class="paraquien secciones" id="mas">
        <div class="container">
            <div class="row">
                <div class="wow fadeInLeft" data-wow-delay="0.5s">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-sm-8">
                    <h3><b>Programación:</b></h3>
                    <ul id="lista-temas"></ul>
                </div>
                <div class="col-md-4 col-sm-4 text-center">
                    <p class="text-center"></p><a href="{{$landinfo->link_temario}}" target="_blank" class="btn btn-primary btn-sm">Ver programa completo</a>
                </div>
            </div>
        </div>
    </section>
