...
{{-- este es el nuevo webinar con un rediseño --}}
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="/css/landing/newwebinar.css">
...
{{-- de aqui empieza el webinar a editar --}}
        ...
        <div class="">
         <div class="container">
           <div class="row">
            ...
            <div class="fondo-gray col-md-5 col-sm-4 secciones">
            <div class="col-md-10 col-md-offset-1 col-sm-5  text-right">
                        <div class="wow fadeInDown" data-wow-delay="0.3s">
                            <img class="img-responsive" src="{{ $landinfo->img_producto }}">
                        </div>
            </div>
                  
            <section class="secciones" id="info">
            ...
            <h3 class="text-left"> Webinar</h3>
            <h2 class="text-left p-color-blnc">{{ $landinfo->nombre_evento }}</h2>

             
               <ul class="p-color-blnc" id="lista-temas"></ul>
             
           
             <h3 class="text-center">{{ $meses[$m-1] }} {{ $landinfo->numero_dias_evento }}, {{ $landinfo->anio }} | {{ $landinfo->horario_evento }}</h3>
                             
               <br>
                    <div class="col-md-12" >
                        <div class="wow fadeInRight" data-wow-delay="0.7s">
                        @if($landinfo->precio_evento <>0)
                          <a href="">  <p class="text-left p-color-blnc">¡Registrarme ahora!</p></a>
                        @else
                            <p class="text-center p-color-blnc">¡Registrarme ahora! <b>¡GRATIS!</b></a></p>
                        @endif
                       ...
                       {{-- <form class="form-horizontal" > --}}
                        {!! Form::open(array('url' =>'calendario/evento/reservacion', 'class' => 'form-horizontal')) !!}
                            ...
                            <div class="col-md-10 col-md-offset-1">
                                <div class="espaciodiv form-group">
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa icon-v-card"></i></div>
                                        <input name="nombre" type="text" class="form-control" placeholder="Nombre" onkeypress="return minus(event)">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-10 col-md-offset-1">
                                <div class="espaciodiv form-group">
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa icon-v-card"></i></div>
                                        <input name="apellidos" type="text" class="form-control" placeholder="Apellidos" onkeypress="return minus(event)">
                                    </div>
                                </div>
                            </div>    
                            ...
                            <div class="col-md-10 col-md-offset-1">
                                <div class="espaciodiv form-group">
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa icon-mobile fa-x2"></i></div>
                                        <input name="telefono" type="tel" class="form-control" placeholder="Telefono" onkeypress="return numeros(event)" maxlength='10'>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row derechos-res">
                            <div class="col-md-12">
                                <p class="text-center"> Copyright 2017 © Todos los Derechos Reservados <a style="text-decoration: none;" href="{{url('/') }}">Inelco IT Solutions S.A. de C.V.</a></p><p class="text-center"><span style="color:transparent;">C: {{ $landinfo->id_calendario}}</span><span style="color:transparent;"> L: {{ $landinfo->id}}</span></p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="/js/ocultadiv.js"></script>
