    ...
    <section class="eventos secciones">
        ...
        <div id="filtros" class="text-center">
           <h3 class="title-h3"> Selecciona el tipo de evento que deseas </h3>
            ...
            <a  class="btn btn-default btn-lg" href="{{ url('/syca-calendario/webinar')}}" >Webinar</a>
            <a class="btn btn-default btn-lg" href="{{ url('/syca-calendario/cursos')}}" >Cursos</a>
            <a class="btn btn-default btn-lg" href="{{ url('/syca-calendario/presentaciones')}}" >Presentaciones</a>
            <a class="btn btn-default btn-lg" href="{{ url('/syca-calendario/talleres')}}" >Talleres</a>
            <a id='activo' class="btn btn-default btn-lg" href="{{ url('/syca-calendario/conferencias')}}" >Conferencias</a>


                      
        </div>

        @if(count($sycaConferencias) > 0)
            @php
                $lastmes=0;
                $lastanio=0;
            @endphp
            ...
            @foreach ($sycaConferencias as $evento)
