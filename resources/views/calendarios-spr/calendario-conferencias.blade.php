...
{{-- se cambia --}}
            ...
            <a id='activo' class="btn btn-default btn-lg" href="{{ url('/solucionespararestaurantes-calendario/conferencias')}}" >Conferencias</a>


                      
            </div>

        @if(count($sprConferencias) > 0)
            @php
                $lastmes=0;
                $lastanio=0;
            @endphp
            ...
            @foreach ($sprConferencias as $evento)
