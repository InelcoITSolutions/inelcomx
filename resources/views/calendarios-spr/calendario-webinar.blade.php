...
{{-- se cambia --}}
            ...
            <a id='activo' class="btn btn-default btn-lg" href="{{ url('/solucionespararestaurantes-calendario/webinar')}}" >Webinar</a>
