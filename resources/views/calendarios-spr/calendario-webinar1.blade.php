...
<body>
    ...
    <section class="eventos secciones">
        ...
        <div id="filtros" class="text-center">
           <h3 class="title-h3"> Selecciona el tipo de curso que deseas </h3>
            <br>

            <a  class="btn btn-default btn-lg " href="{{ url('/syca-calendario')}}" >Todos</a>
            <a id='activo' class="btn btn-default btn-lg" href="{{ url('/syca-calendario/webinar')}}" >Webinar</a>
