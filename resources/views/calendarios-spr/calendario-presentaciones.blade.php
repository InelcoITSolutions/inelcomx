...
{{-- se cambia --}}
            ...
            <a id='activo' class="btn btn-default btn-lg" href="{{ url('/solucionespararestaurantes-calendario/presentaciones')}}" >Presentaciones</a>
            <a class="btn btn-default btn-lg" href="{{ url('/solucionespararestaurantes-calendario/talleres')}}" >Talleres</a>
        ...
        @if(count($sprPresentaciones) > 0)
            ...
            @foreach ($sprPresentaciones as $evento)
