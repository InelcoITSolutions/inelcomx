        ...
        <div class="container">
         ...
         <div id="filtros" class="text-center">
           <h3 class="title-h3"> Selecciona el tipo de evento que deseas </h3>
            ...
            <a class="btn btn-default btn-lg" href="{{ url('/aspelsoluciones-calendario/presentaciones')}}" >Presentaciones</a>
            <a class="btn btn-default btn-lg" href="{{ url('/aspelsoluciones-calendario/talleres')}}" >Talleres</a>
            <a  id='activo' class="btn btn-default btn-lg" href="{{ url('/aspelsoluciones-calendario/conferencias')}}" >Conferencias</a>


                      
        </div>

        @if(count($aspelConferencias) > 0)
            @php
                $lastmes=0;
                $lastanio=0;
            @endphp
            ...
            @foreach ($aspelConferencias as $evento)
