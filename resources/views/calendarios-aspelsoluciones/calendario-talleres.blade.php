...
<body>
    ...
    <section class="eventos secciones">
        <div class="container">
         ...
         <div id="filtros" class="text-center">
           <h3 class="title-h3"> Selecciona el tipo de evento que deseas </h3>
            ...
            <a id='activo' class="btn btn-default btn-lg" href="{{ url('/aspelsoluciones-calendario/talleres')}}" >Talleres</a>
        ...
        @if(count($aspelTalleres) > 0)
            ...
            @foreach ($aspelTalleres as $evento)
