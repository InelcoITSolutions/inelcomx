...
<head>
    ...
    <title>Calendario eventos | Aspel Soluciones</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <link rel="stylesheet" href="/css/bootstrap.min.css">
    <link rel="stylesheet" href="/css/mis-estilos-aspelcalendario.css">
    <link rel="stylesheet" href="/css/footercalendario.css">
...
<body>
     ...
     <div class="container-fluid">
            <div class="row">
                <div class="col-md-3 col-xs-2">
                    <ul>
                        <li><a href="https://www.facebook.com/NuevoSAE7/" target="_blank"><span class="icon-facebook"></span></a></li>
                        <li><a href="https://twitter.com/AspelSoluciones" target="_blank"><span class="icon-twitter"></span></a></li>
                        <li><a href="https://plus.google.com/100601891807685848158" target="_blank"><span class="icon-google4"></span></a></li>
                ...
                <div class="col-md-9 col-xs-8">
                    <ul>
                        ...
                        <li>|</li>
                        <li><span class="icon-mail5"></span> contacto@aspelsoluciones.com</li>
                        
                        
                           
                                <li><a href="{{ url('https://www.aspelsoluciones.com/') }} "><span class="glyphicon glyphicon-home"></span> Inicio</a></li>
    ...
    <div class="col-md-12 fondo-gray">
        <div class="col-md-9 ">
            <h2 id="tias" class="title-h2"><b>Calendario de eventos Aspel Soluciones</b></h2>
        ...
        <div class="col-md-3 ">
        <img alt="inelco-aspel-coi-transp" class="img-responsive" width="100%"  src="/images/Inelco-aspelsoluciones_logoblanco.png">
        </div>
    </div>
        ...
        <div class="container">
         ...
         <div id="filtros" class="text-center">
           <h3 class="title-h3"> Selecciona el tipo de evento que deseas </h3>
            ...
            <a  class="btn btn-default btn-lg " href="{{ url('/aspelsoluciones-calendario')}}" >Todos</a>
            <a  class="btn btn-default btn-lg" href="{{ url('/aspelsoluciones-calendario/webinar')}}" >Webinar</a>
            <a class="btn btn-default btn-lg" href="{{ url('/aspelsoluciones-calendario/cursos')}}" >Cursos</a>
            <a id='activo' class="btn btn-default btn-lg" href="{{ url('/aspelsoluciones-calendario/presentaciones')}}" >Presentaciones</a>
            <a class="btn btn-default btn-lg" href="{{ url('/aspelsoluciones-calendario/talleres')}}" >Talleres</a>
            <a  class="btn btn-default btn-lg" href="{{ url('/aspelsoluciones-calendario/conferencias')}}" >Conferencias</a>


                      
        </div>

        @if(count($aspelPresentaciones) > 0)
            @php
                $lastmes=0;
                $lastanio=0;
            @endphp
            ...
            @foreach ($aspelPresentaciones as $evento)
...
@push('add-js')   
    ...
    @include('templates.footercalendario')
